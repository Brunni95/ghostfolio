...
export const CASHFLOW_QUEUE = 'CASHFLOW_QUEUE';
export const DEFAULT_PROCESSOR_CASHFLOW_CONCURRENCY = 1;
export const PROCESS_RECURRING_CASHFLOW_JOB_NAME = 'PROCESS_RECURRING_CASHFLOWS';
export const PROCESS_RECURRING_CASHFLOW_JOB_OPTIONS: JobOptions = {
  removeOnComplete: true,
  jobId: PROCESS_RECURRING_CASHFLOW_JOB_NAME
};
