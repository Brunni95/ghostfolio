...
export const permissions = {
  ...
  createCashflowSeries: 'createCashflowSeries',
  ...
  deleteCashflowSeries: 'deleteCashflowSeries',
  ...
  updateCashflowSeries: 'updateCashflowSeries',
  ...
  switch (aRole) {
    case 'ADMIN':
      return [
        ...
        permissions.createCashflow,
        permissions.createCashflowSeries,
        permissions.createCashflow,
        permissions.createCashflowSeries,
        permissions.createWatchlistItem,
        permissions.deleteAccountBalance,
        permissions.deleteCashflow,
        permissions.deleteCashflowSeries,
        permissions.deleteCashflow,
        permissions.deleteCashflowSeries,
        ...
        permissions.updateCashflow,
        permissions.updateCashflowSeries,
        permissions.updateCashflow,
        permissions.updateCashflowSeries,
